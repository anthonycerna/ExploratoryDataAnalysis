...
with(electric, plot(Date.Time, Global_active_power, type="l",
...
with(electric, plot(Date.Time, Voltage, type="l", xlab="datetime"))

with(electric, plot(Date.Time, Global_reactive_power, type="l", xlab="datetime"))
